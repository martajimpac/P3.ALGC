            ...
            for (int y=0; y<noYCells; y++) {
                ...
                switch((int) data[y][x]){
                    ...
                    case CICLO:
                        ...
                        heatMapGraphics.setColor( Color.BLACK );
                        heatMapGraphics.drawString("CC",cellX,cellY +(1*cellSize.height)-3);
                        break;
                    case COSTURA:
                        //pintar ciclos
                        ...
                        heatMapGraphics.setColor( Color.BLACK );
                        heatMapGraphics.drawString("CO",cellX,cellY +(1*cellSize.height)-3);
                        break;
                    default:
                        // Si ha sido pintado pintar la profundidad
                        ...
                        heatMapGraphics.drawString(profundidad,cellX,cellY +(1*cellSize.height)-3);
                        break;
                }
            }
        }
